...
class SpotifyClient:
    ...
    def get_track_recommendations(self, **kwags):
    ...
    def search_for_item(self, type, q, limit=20):
        self.user_authorization()
    ...
    def create_playlist(self, title):
        ...
        payload = json.dumps({
            "name": title,
            "description": f"This playlist is automatically generated by the Spotify playlist generator on {date.today()}.",
            "public": "false"
        })
